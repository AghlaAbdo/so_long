...
/*   Updated: 2024/01/26 10:06:13 by aaghla           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (state == 0)
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->door_c, x, y);
	else if (state == 1)
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->door_o, x, y);
}
